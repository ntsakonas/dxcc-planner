            ...
            try (Stream<String> countryFile = br.lines()) {
                return countryFile
                        ...
                        .map(entityDetails ->
                                ...
                                new DXCCCountry(entityDetails[0].replace("*","").toUpperCase(), entityDetails[1], entityDetails[3], Double.parseDouble(entityDetails[6]), -Double.parseDouble(entityDetails[7]))
                        )
